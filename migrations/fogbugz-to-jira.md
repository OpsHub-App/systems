# Zero Downtime FogBugz to Jira Migration

**Migrate to Jira from FogBugz with zero downtime and complete data fidelity.**

[![Start Now](https://img.shields.io/badge/Start_Now-0052CC?style=for-the-badge&logo=atlassian&logoColor=white)](https://marketplace.atlassian.com/apps/257470442)

Migrate from FogBugz to Jira without downtime. Preserve cases, discussions, attachments, and complete project history throughout the transition.
...
OpsHub Migration Manager connects to FogBugz and Jira through their APIs and runs the migration in the background while your teams continue working.

The migration process follows three steps:

1. **Export** — OpsHub reads data from FogBugz via its API. No plugins or admin access required in the source system.
...
- Teams moving from FogBugz to Jira for modern project management
- Preserving complete FogBugz case history in Jira
- Zero-disruption migration from FogBugz with incremental sync support
...
No. OpsHub runs migrations with zero downtime. Your teams continue working in FogBugz throughout the migration process. Incremental delta syncs capture any changes made after the initial load, so nothing is lost during the transition.
