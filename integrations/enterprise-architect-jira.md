# Sparx Enterprise Architect and Jira Integration

**Seamlessly connect Sparx Enterprise Architect and Jira with real-time, bidirectional sync.**

[![Get It Now](https://img.shields.io/badge/Get_It_Now-0052CC?style=for-the-badge&logo=atlassian&logoColor=white)](https://marketplace.atlassian.com/apps/1234974)

Bidirectionally integrate Sparx EA elements, diagrams, and packages with Jira issues using a simple drag-and-drop interface. Bridge model-based systems engineering with agile development.
...
- Systems engineers modeling in EA while developers track work in Jira
- Linking architecture models to development tasks for traceability
- MBSE teams needing visibility between design models and Jira backlogs
