# Jira Align Integration for Jira

**Seamlessly connect Jira Align and Jira with real-time, bidirectional sync.**

[![Get It Now](https://img.shields.io/badge/Get_It_Now-0052CC?style=for-the-badge&logo=atlassian&logoColor=white)](https://marketplace.atlassian.com/apps/1237429)

Connect Jira Align portfolio management with Jira execution through OpsHub Integration Manager. Synchronize epics, features, and strategic themes across both platforms.

## Why Integrate Jira Align with Jira?
...
| **Always Accurate** | Real-time synchronization ensures Jira Align and Jira always show the same information. No stale data, no conflicts. |
...
Epics, features, capabilities, strategic themes, programs, iterations, and custom fields
...
OpsHub Integration Manager connects Jira Align and Jira through their native APIs, operating as an external engine between both platforms. No plugins are installed inside your systems, so there is zero performance impact on either tool.

The integration process follows three steps:

1. **Connect** — Provide API credentials for Jira Align and Jira. Standard service account permissions are sufficient.
...
- Portfolio teams in Jira Align aligning with delivery teams in Jira
- Synchronizing SAFe artifacts between Jira Align and Jira
- Enterprise agile planning with connected portfolio and team-level data
...
**Why do teams integrate Jira Align with Jira?**

Jira Align and Jira are often used by different teams within the same organization. Without integration, teams waste time on manual data entry, work with outdated information, and lose visibility across workflows. OpsHub keeps both systems synchronized automatically, so each team continues working in their preferred tool while staying aligned on priorities and progress.
...
If you use Jira Align with Jira, you may also need:
