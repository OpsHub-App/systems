# OpenText ALM (HP ALM) and Jira Integration

**Seamlessly connect OpenText ALM / HP ALM / Micro Focus ALM and Jira with real-time, bidirectional sync.**

[![Get It Now](https://img.shields.io/badge/Get_It_Now-0052CC?style=for-the-badge&logo=atlassian&logoColor=white)](https://marketplace.atlassian.com/apps/1236342)

Synchronize issues and tests between OpenText ALM (formerly HP ALM / Micro Focus ALM) and Jira with two-way, rich data sync. Connect quality management with agile development.

## Why Integrate OpenText ALM / HP ALM / Micro Focus ALM with Jira?
...
| **Always Accurate** | Real-time synchronization ensures OpenText ALM / HP ALM / Micro Focus ALM and Jira always show the same information. No stale data, no conflicts. |
...
Defects, requirements, tests, test sets, test runs, comments, attachments, and custom fields
...
OpsHub Integration Manager connects OpenText ALM / HP ALM / Micro Focus ALM and Jira through their native APIs, operating as an external engine between both platforms. No plugins are installed inside your systems, so there is zero performance impact on either tool.

The integration process follows three steps:

1. **Connect** — Provide API credentials for OpenText ALM / HP ALM / Micro Focus ALM and Jira. Standard service account permissions are sufficient.
...
- QA teams on ALM working alongside development teams on Jira
- Migrating workflows from HP ALM to Jira while keeping both systems active
- Enterprise testing teams needing visibility across ALM and Jira
...
**Why do teams integrate OpenText ALM / HP ALM / Micro Focus ALM with Jira?**

OpenText ALM / HP ALM / Micro Focus ALM and Jira are often used by different teams within the same organization. Without integration, teams waste time on manual data entry, work with outdated information, and lose visibility across workflows. OpsHub keeps both systems synchronized automatically, so each team continues working in their preferred tool while staying aligned on priorities and progress.
...
If you use OpenText ALM / HP ALM / Micro Focus ALM with Jira, you may also need:

- [Tricentis Tosca Integration for Jira](tricentis-tosca-jira.md)
- [Tricentis qTest and Jira Integration](tricentis-qtest-jira.md)
- [TestRail Integration for Jira](testRail-jira.md)
