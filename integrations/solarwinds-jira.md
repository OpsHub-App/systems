# SolarWinds Service Desk Integration for Jira

**Seamlessly connect SolarWinds Service Desk and Jira with real-time, bidirectional sync.**

[![Get It Now](https://img.shields.io/badge/Get_It_Now-0052CC?style=for-the-badge&logo=atlassian&logoColor=white)](https://marketplace.atlassian.com/apps/1591510710)

Bidirectional sync between SolarWinds Service Desk and Jira. Connect IT service management with development workflows to keep service and engineering teams aligned.

## Why Integrate SolarWinds Service Desk with Jira?
...
| **Always Accurate** | Real-time synchronization ensures SolarWinds Service Desk and Jira always show the same information. No stale data, no conflicts. |
...
Incidents, requests, problems, changes, tasks, comments, attachments, and custom fields
...
OpsHub Integration Manager connects SolarWinds Service Desk and Jira through their native APIs, operating as an external engine between both platforms. No plugins are installed inside your systems, so there is zero performance impact on either tool.

The integration process follows three steps:

1. **Connect** — Provide API credentials for SolarWinds Service Desk and Jira. Standard service account permissions are sufficient.
...
- IT service desk teams on SolarWinds while engineering uses Jira
- Automatic escalation from SolarWinds tickets to Jira development tasks
- Unified service and development visibility across SolarWinds and Jira
...
**Why do teams integrate SolarWinds Service Desk with Jira?**
...
If you use SolarWinds Service Desk with Jira, you may also need:
